...
class BlogAdapter(var items : ArrayList<Blog>, var clickListener: OnBlogItemClickListener) : RecyclerView.Adapter<BlogViewHolder>(){
    override fun getItemCount(): Int {
        return items.size
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BlogViewHolder {
        return BlogViewHolder(LayoutInflater.from(parent.context).inflate(
